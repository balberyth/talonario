...
const verDatosParticipante = () => {
  participante.value = clientes.value.find((cliente) =>
  ...
  <div id="all" :style="{ backgroundColor: colorFondo }">
    ...
    <div id="datosParticipante" v-if="datosParticipanteVisible">
      ...
      <h3>
        Boleta
        <span>{{
          participante.indice > 10
            ? participante.indice
            : "0" + participante.indice
        }}</span>
      </h3>
      <p>
        Estado:
        <span>{{
          participante.pagar === "si" ? "Comprada 🔵" : "Reservada 🔴"
        }}</span>
      </p>
      <div>
    ...
    <main>
      <section id="informacion">
        ...
        <div id="infoContenido">
          <p>
            🏆<span>{{
              mostrarBoletas == true ? premio.toLocaleString() : ""
            }}</span>
          </p>
          <p>
            💰<span>{{
              mostrarBoletas == true ? precioBoleta.toLocaleString() : ""
            }}</span>
          </p>
          <p>
